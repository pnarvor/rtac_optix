...
std::string to_file(const Buffer& buffer, const std::string& path, float a = 1.0, float b = 0.0);

void display(const Buffer& buffer, float a = 1.0, float b = 0.0, const std::string& filePath = "tmp");
void display_ascii(const Buffer& buffer, float a = 1.0, float b = 0.0,
